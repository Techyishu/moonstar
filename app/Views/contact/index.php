...
<section class="relative bg-primary-950 py-24 px-4 sm:px-6 lg:px-8 text-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-3xl mx-auto">
        <h1 class="text-4xl md:text-5xl font-bold font-heading text-white mb-6">Get in Touch</h1>
        <p class="text-lg text-primary-200">We'd love to hear from you. Here's how you can reach us.</p>
    </div>
</section>

<!-- Contact Info Cards -->
<section class="py-16 -mt-10 relative z-20 px-4">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Address -->
        <div
            class="bg-white rounded-2xl shadow-xl p-8 text-center border-b-4 border-accent-400 group hover:-translate-y-1 transition-transform cursor-default">
            <div
                class="w-16 h-16 mx-auto bg-accent-50 text-accent-600 rounded-full flex items-center justify-center mb-6 group-hover:bg-accent-600 group-hover:text-white transition-colors">
        ...
        <!-- Phone -->
        <div
            class="bg-white rounded-2xl shadow-xl p-8 text-center border-b-4 border-primary-500 group hover:-translate-y-1 transition-transform cursor-default">
            <div
                class="w-16 h-16 mx-auto bg-primary-50 text-primary-600 rounded-full flex items-center justify-center mb-6 group-hover:bg-primary-600 group-hover:text-white transition-colors">
                <svg class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <p class="text-slate-500 mb-1"><span class="font-semibold text-slate-700">Admin:</span> +1 (123) 456-7890
            </p>
            <p class="text-slate-500"><span class="font-semibold text-slate-700">Admissions:</span> +1 (123) 456-7899
            </p>
        </div>

        <!-- Email -->
        <div
            class="bg-white rounded-2xl shadow-xl p-8 text-center border-b-4 border-emerald-400 group hover:-translate-y-1 transition-transform cursor-default">
            <div
                class="w-16 h-16 mx-auto bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mb-6 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                <svg class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <p class="text-slate-500 text-sm mb-2"><a href="mailto:info@moonstart.edu"
                    class="hover:text-primary-600 transition-colors">info@moonstar.edu</a></p>
            <p class="text-slate-500 text-sm"><a href="mailto:admissions@moonstart.edu"
                    class="hover:text-primary-600 transition-colors">admissions@moonstar.edu</a></p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 border border-slate-100">
                <h2 class="text-2xl font-bold font-heading text-slate-800 mb-6">Send a Message</h2>
                <form action="<?= base_url('contact/submit') ?>" method="post" class="space-y-6">
                    ...
                    <button type="submit"
                        class="w-full py-4 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5">
                        Send Message
                    </button>
                </form>
            </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-slate-200 rounded-2xl overflow-hidden shadow-lg h-80 relative group">
                    ...
                    <div
                        ...
                        <div>
                            <p class="text-sm font-bold text-slate-800">Main Campus</p>
                            <p class="text-xs text-slate-500">123 Education St</p>
                        </div>
