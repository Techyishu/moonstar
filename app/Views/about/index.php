...
<!-- Hero Header -->
<section class="relative bg-primary-950 py-32 px-4 sm:px-6 lg:px-8 text-center overflow-hidden">
    <!-- Decorative background -->
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl">
        <div class="absolute top-20 left-10 w-64 h-64 bg-primary-700/30 rounded-full blur-3xl animate-pulse"></div>
        <div class="absolute bottom-20 right-10 w-64 h-64 bg-accent-500/20 rounded-full blur-3xl"
            style="animation-delay: 1.5s"></div>
    </div>

    <div class="relative z-10 max-w-4xl mx-auto">
        <h1 class="text-4xl md:text-6xl font-bold font-heading text-white mb-6 animate-fade-in-up">About Moonstar</h1>
        <p class="text-xl text-primary-200 leading-relaxed font-light">
...
<section class="py-24 bg-white relative -mt-16 z-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Mission -->
            <div
                class="bg-white rounded-2xl shadow-xl p-10 border-t-4 border-accent-400 transform hover:-translate-y-2 transition-all duration-300">
                <div class="w-16 h-16 rounded-2xl bg-accent-50 text-accent-600 flex items-center justify-center mb-6">
                    <svg class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                </div>
                <h2 class="text-2xl font-bold font-heading text-primary-950 mb-4">Our Mission</h2>
            ...
            <!-- Vision -->
            <div
                class="bg-white rounded-2xl shadow-xl p-10 border-t-4 border-primary-500 transform hover:-translate-y-2 transition-all duration-300">
                <div class="w-16 h-16 rounded-2xl bg-primary-50 text-primary-600 flex items-center justify-center mb-6">
                    <svg class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <h2 class="text-2xl font-bold font-heading text-primary-950 mb-4">Our Vision</h2>
                <p class="text-slate-600 leading-relaxed text-lg">
...
<section class="py-24 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <span class="text-accent-500 font-bold tracking-wider uppercase text-sm">Our Philosophy</span>
            <h2 class="text-3xl md:text-5xl font-bold font-heading text-primary-950 mt-2">Core Values</h2>
            <p class="mt-4 text-slate-500 max-w-2xl mx-auto">The principles that guide our everyday interactions and educational approach.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Value 1 -->
            <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-slate-100 group">
             ...
             <!-- Value 3 -->
             <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-slate-100 group">
                <div class="w-12 h-12 bg-pink-50 text-pink-600 rounded-xl flex items-center justify-center mb-6 group-hover:bg-pink-600 group-hover:text-white transition-colors">
                ...
                <p class="text-slate-600">We cultivate kindness, understanding, and respect for others' perspectives.</p>
            </div>

             <!-- Value 4 -->
             <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-slate-100 group">
                <div class="w-12 h-12 bg-green-50 text-green-600 rounded-xl flex items-center justify-center mb-6 group-hover:bg-green-600 group-hover:text-white transition-colors">
...
<section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-5xl font-bold font-heading text-primary-950">Meet Our Leaders</h2>
            <p class="mt-4 text-slate-500 max-w-2xl mx-auto">The dedicated educators guiding our path.</p>
        </div>
